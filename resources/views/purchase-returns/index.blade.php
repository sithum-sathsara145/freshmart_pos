...
<table style="width:100%;border-collapse:collapse;font-size:12px">
    <thead><tr style="border-bottom:.5px solid #2a2d3a">
        @foreach(['Dr. Note #','Supplier','Ref Bill','Date','Amount','Reason','Status'] as $h)
    ...
    @empty
    <tr><td colspan="7" style="padding:32px;text-align:center;color:#4a5568">No purchase returns found</td></tr>
    @endforelse
    </tbody>
</table>
</div>
