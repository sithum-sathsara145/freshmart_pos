{{-- expense-categories/edit.blade.php --}}
@extends('layouts.app')
...
<div style="display:flex;gap:8px;margin-top:12px">
    <a href="{{ route('expense-categories.index') }}" style="height:36px;padding:0 16px;background:var(--surface-2);border:.5px solid var(--border);border-radius:6px;color:var(--text-2);font-size:12px;display:flex;align-items:center;text-decoration:none">Cancel</a>
