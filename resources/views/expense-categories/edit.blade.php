...
<div style="display:flex;gap:8px;margin-top:12px">
    <a href="{{ route('expense-categories.index') }}" style="height:36px;padding:0 16px;background:#1e2130;border:.5px solid #2a2d3a;border-radius:6px;color:#94a3b8;font-size:12px;display:flex;align-items:center;text-decoration:none">Cancel</a>
