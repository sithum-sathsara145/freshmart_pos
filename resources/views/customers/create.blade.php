...
<div style="background:#161821;border:.5px solid #2a2d3a;border-radius:8px;padding:16px;margin-top:12px">
    ...
    <label style="display:flex;align-items:center;gap:8px;font-size:12px;color:#e2e8f0;margin-bottom:12px;cursor:pointer">
        <input type="checkbox" name="credit_approved" value="1" {{ old('credit_approved') ? 'checked' : '' }} style="width:16px;height:16px;accent-color:#4ade80">
...
<div style="display:flex;gap:8px;margin-top:12px">
    <a href="{{ route('customers.index') }}" style="height:36px;padding:0 16px;background:#1e2130;border:.5px solid #2a2d3a;border-radius:6px;color:#94a3b8;font-size:12px;display:flex;align-items:center;text-decoration:none">Cancel</a>
    <button type="submit" style="height:36px;padding:0 20px;background:#14532d;color:#4ade80;border:.5px solid #166534;border-radius:6px;font-size:12px;font-weight:500;cursor:pointer"><i class="ti ti-check" style="font-size:13px;margin-right:4px"></i>Save Customer</button>
</div>
</form>
</div>
@endsection
