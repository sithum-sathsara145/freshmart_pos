...
<div style="background:#161821;border:.5px solid #2a2d3a;border-radius:8px;padding:16px;margin-bottom:12px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
        <div>
            <label style="display:block;font-size:11px;color:#64748b;margin-bottom:4px">Joined</label>
            <div style="{{ $inp }};color:#64748b">{{ $staff->join_date ? \Carbon\Carbon::parse($staff->join_date)->format('d M Y') : '—' }}</div>
        </div>
        <div>
