...
<div style="background:#161821;border:.5px solid #2a2d3a;border-radius:8px;padding:14px">
    <div style="font-size:12px;font-weight:500;color:#94a3b8;margin-bottom:10px">Upcoming holidays</div>
    <table style="width:100%;border-collapse:collapse;font-size:12px">
        ...
        <tr style="border-bottom:.5px solid #1a1d2a">
            ...
            <td style="padding:7px 10px;color:#64748b">{{ \Carbon\Carbon::parse($h->date)->format('d M Y') }}</td>
