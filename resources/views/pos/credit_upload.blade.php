...
<style>
    *{box-sizing:border-box;margin:0;padding:0}
    body{font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;background:var(--bg);color:var(--text);min-height:100vh;display:flex;align-items:flex-start;justify-content:center;padding:18px}
    .card{background:var(--surface);border:.5px solid var(--border);border-radius:14px;padding:20px;width:100%;max-width:420px;margin-top:20px}
    h1{font-size:17px;font-weight:600;margin-bottom:4px}
    .sub{font-size:12px;color:var(--text-3);margin-bottom:16px}
    .meta{background:var(--bg);border:.5px solid var(--border);border-radius:8px;padding:10px 12px;margin-bottom:16px;font-size:13px}
    .meta .r{display:flex;justify-content:space-between;padding:2px 0}
    .meta .r span:first-child{color:var(--text-3)}
    label{display:block;font-size:12px;color:var(--text-2);margin-bottom:6px;margin-top:14px}
    input[type=file],input[type=text]{width:100%;background:var(--bg);border:.5px solid var(--border);border-radius:8px;color:var(--text);font-size:15px;padding:12px;outline:none}
    input[type=text]{letter-spacing:1px}
    button{width:100%;height:50px;margin-top:20px;background:var(--primary-solid);border:.5px solid var(--primary-border);border-radius:9px;color:#fff;font-size:15px;font-weight:600;cursor:pointer}
    button:disabled{opacity:.55}
    .err{background:var(--danger-soft-3);border:.5px solid var(--danger-soft);color:var(--danger-text);border-radius:8px;padding:10px 12px;font-size:13px;margin-top:14px}
    #status{font-size:13px;color:var(--primary-text);margin-top:12px;text-align:center;min-height:16px}
    .done{width:60px;height:60px;border-radius:50%;background:var(--success-soft);color:var(--success);font-size:34px;display:flex;align-items:center;justify-content:center;margin:6px auto 14px}
    .hint{font-size:11px;color:var(--text-5);margin-top:6px}
</style>
</head>
<body>
