...
<div style="background:#161821;border:.5px solid #2a2d3a;border-radius:8px;padding:14px;align-self:start">
    ...
    <button type="submit" style="width:100%;height:36px;background:#14532d;color:#4ade80;border:.5px solid #166534;border-radius:6px;font-size:12px;font-weight:500;cursor:pointer"><i class="ti ti-plus" style="font-size:13px;margin-right:4px"></i>Add Brand</button>
...
<div style="background:#161821;border:.5px solid #2a2d3a;border-radius:8px;padding:14px">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
        <div style="font-size:12px;font-weight:500;color:#94a3b8">All brands</div>
    ...
    <table style="width:100%;border-collapse:collapse;font-size:12px">
        ...
        <tr style="border-bottom:.5px solid #1a1d2a">
            <td style="padding:7px 10px;color:#e2e8f0;font-weight:500">{{ $b->name }}</td>
            <td style="padding:7px 10px;color:#64748b">{{ $b->description ?? '—' }}</td>
            <td style="padding:7px 10px;color:#94a3b8">{{ $b->products_count }}</td>
            <td style="padding:7px 10px">
                <div style="display:flex;gap:3px">
                    <a href="{{ route('brands.edit',$b) }}" style="width:26px;height:26px;background:#1e2130;border:.5px solid #2a2d3a;border-radius:5px;display:flex;align-items:center;justify-content:center;color:#94a3b8;text-decoration:none"><i class="ti ti-edit" style="font-size:12px"></i></a>
        ...
        @empty
        <tr><td colspan="4" style="padding:24px;text-align:center;color:#4a5568">No brands yet</td></tr>
        @endforelse
        </tbody>
    </table>
