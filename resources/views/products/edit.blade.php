...
<div style="background:var(--surface);border:.5px solid var(--border);border-radius:8px;padding:14px;margin-bottom:12px">
    ...
    @endforeach
    <div style="margin-bottom:10px">
        <label style="display:block;font-size:11px;color:var(--text-3);margin-bottom:4px">SKU (6 digits) — item code</label>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
        <div><label style="display:block;font-size:11px;color:var(--text-3);margin-bottom:4px">Category</label>
        ...
        <div><label style="display:block;font-size:11px;color:var(--text-3);margin-bottom:4px">Brand</label>
...
<div style="background:var(--surface);border:.5px solid var(--border);border-radius:8px;padding:14px">
    <div style="font-size:12px;font-weight:500;color:var(--text-2);margin-bottom:12px">Pricing</div>
    ...
    @endforeach
    <div><label style="display:block;font-size:11px;color:var(--text-3);margin-bottom:4px">Status</label>
    ...
    <label style="display:flex;align-items:center;gap:6px;font-size:12px;color:var(--text-2);cursor:pointer;margin-top:12px">
        <input type="checkbox" name="show_in_online_store" value="1" {{ old('show_in_online_store', $product->show_in_online_store) ? 'checked' : '' }} style="accent-color:var(--primary)">
...
<div style="display:flex;gap:8px;margin-top:14px">
    ...
    <a href="{{ route('products.barcode',$product) }}" style="height:36px;padding:0 14px;background:var(--info-soft);color:var(--info);border:.5px solid var(--info-soft);border-radius:6px;font-size:12px;display:flex;align-items:center;gap:4px;text-decoration:none"><i class="ti ti-barcode" style="font-size:13px"></i>Print barcode</a>
    <button type="submit" style="height:36px;padding:0 20px;background:var(--success-soft);color:var(--success);border:.5px solid var(--success-border);border-radius:6px;font-size:12px;font-weight:500;cursor:pointer"><i class="ti ti-check" style="font-size:13px;margin-right:4px"></i>Update Product</button>
</div>
</form>
</div>
@endsection
