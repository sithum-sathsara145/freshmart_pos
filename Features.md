...
<!-- NEW-FEATURES -->
- **2026-07-21 — Purchase reports** — See everything you have bought from one screen: each goods-received note with what was paid and what is still owed, totalled by date, by supplier or by item, plus the debit notes for goods sent back. Filter by supplier or by whether the bill is settled, and export any of it to PDF or Excel. Buying prices stay hidden from staff who are not allowed to see purchases.
- **2026-07-21 — Sales & profit reports** — Gross profit the way you need to see it — by item, category, supplier, branch, invoice or customer, all from one screen. Plus net profit day by day after cost and expenses, and a refunds report showing what came back and the margin that went with it. Returns are netted off, so a refunded sale stops counting as profit.
- **2026-07-21 — Transaction & cash book reports** — New reports for the daily paperwork: every invoice with daily totals and credit notes; takings by cashier, broken down by the customers they served or the items they sold; a cash book with running balance, account balances and the day's till hand-overs showing which notes came in; and expenses totalled by category or by date. All of them export to PDF, Excel and CSV.
